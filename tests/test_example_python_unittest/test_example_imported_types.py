...
class TestExampleImportedTypes(unittest.TestCase):
    def test_imported_types_returns_sub_context_manager(self):
        expected = [3, 5, 8]
    ...
    def test_imported_types_values_ignored_returns_sub_context_manager(self):
        expected = [3, 5, 8]
        it = ImportedTypes(Cursor)
    ...
    def test_imported_types_not_specified_raises_error(self):
