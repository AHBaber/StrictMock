...
class TestExamplePropertiesArtificialErrors(unittest.TestCase):
    def test_strict_mock_properties_artificial_getter_none_expected_raises_error(self):
    ...
    def test_strict_mock_properties_artificial_getter_incorrect_type_raises_error(self):
    ...
    def test_strict_mock_properties_artificial_setter_none_expected_raises_error(self):
        # when you first create the mock, if you don't have the expected_calls
        # filled out, then you will get errors
        # the lack of proper expected values will cause the mock to
        # raise an error as soon as the property is called
    ...
    def test_strict_mock_properties_artificial_setter_incorrect_value_raises_error(self):
    ...
    def test_strict_mock_properties_artificial_setter_incorrect_type_raises_error(self):
        # error is raised due to the wrong type in returns_value()
        expected = (
            'StrictMock: IncorrectReturnType Discrepancies\n'
            'Data Length\n'
    ...
    def test_strict_mock_properties_artificial_deleter_none_expected_raises_error(self):
        # when you first create the mock, if you don't have the expected_calls
        # filled out, then you will get errors
        # the lack of proper expected values will cause the mock to
        # raise an error as soon as the property is called
