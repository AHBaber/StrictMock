...
class TestExampleFunctions(unittest.TestCase):
    def test_strict_mock_functions_none_expected_raises_error(self):
    ...
    def test_strict_mock_functions_with_args_none_expected_raises_error(self):
    ...
    def test_strict_mock_functions_successful_call(self):
    ...
    def test_strict_mock_functions_return_value_not_set_raises_error(self):
    ...
    def test_strict_mock_functions_wrong_return_value_raises_error(self):
    ...
    def test_strict_mock_functions_method_raises_error(self):
    ...
    def test_strict_mock_functions_values_must_match_to_raise_error(self):
    ...
    def test_strict_mock_functions_with_defaults_successful_call(self):
    ...
    def test_strict_mock_functions_with_pos_and_kwargs(self):
