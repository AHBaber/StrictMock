...
class TestExampleIterator(unittest.TestCase):
    def test_iterator_no_expected_raises_error(self):
        expected = (
        ...
        with self.assertRaises(MockIteratorError) as ex:
            for n in mock:
                pass
    ...
    def test_iterator_for_loop_returns_expected_values(self):
    ...
    def test_iterator_for_loop_with_helper_returns_expected_values(self):
    ...
    def test_iterator_comprehension_returns_expected_values(self):
    ...
    def test_iterator_next_returns_expected_values(self):
    ...
    def test_iterator_next_using_expected_iter_returns_expected_values(self):
        # using only next() means that we need a value
        # to break the loop
        expected = [2, 3]
    ...
    def test_iterator_next_false_returns_expected_values(self):
