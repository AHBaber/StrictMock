...
def test_strict_mock_methods_none_expected_raises_error():
...
def test_strict_mock_methods_with_args_none_expected_raises_error():
...
def test_strict_mock_methods_successful_call():
...
def test_strict_mock_methods_return_value_not_set_raises_error():
...
def test_strict_mock_methods_wrong_return_value_raises_error():
...
def test_strict_mock_methods_method_raises_error():
...
def test_strict_mock_methods_method_with_return_raises_error():
    # you can choose to have a method raise an error instead.
    class MethodRaises:
...
def test_strict_mock_methods_values_must_match_to_raise_error():
...
def test_strict_mock_methods_with_defaults_successful_call():
